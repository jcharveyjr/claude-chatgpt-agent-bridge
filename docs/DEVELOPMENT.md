...
```powershell
git pull
git tag -a v0.2.0 -m "Agent Bridge v0.2.0"
git push origin v0.2.0
gh release create v0.2.0 --notes-file RELEASE_NOTES-v0.2.0.md
```

No `gh` CLI? Push the tag, then on GitHub go to **Releases -> Draft a new
release**, choose the `v0.2.0` tag, and paste the contents of
